...
namespace utf = riakboost::unit_test;
namespace tt  = riakboost::test_tools;
...
#endif
typedef mpl::transform<mutable_char_types,riakboost::add_const<mpl::_1> >::type const_char_types;
...
{
    typedef typename riakboost::remove_const<CharT>::type   mutable_char;
