...
using riakboost::test_tools::output_test_stream;
...
BOOST_AUTO_TEST_CASE( test_is_equal )
{
    ...
    output << '\0';
    BOOST_CHECK( output.is_equal( riakboost::unit_test::const_string( "", 1 ) ) );
    ...
    output << substr1;
    BOOST_CHECK( output.is_equal( riakboost::unit_test::const_string( literal_string, 5 ), false ) );

    output << substr2;
    BOOST_CHECK( output.is_equal( riakboost::unit_test::const_string( literal_string, 9 ) ) );
}
