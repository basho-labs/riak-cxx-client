...
typedef riakboost::test_tools::output_test_stream onullstream_type;
#else
#include <boost/test/utils/nullstream.hpp>
typedef riakboost::onullstream onullstream_type;
#endif
...
BOOST_AUTO_TEST_CASE( test0_only_2 )
{
    ...
    typedef riakboost::mpl::list_c<int,2,2,2,2,2,2,2> only_2;
...
BOOST_AUTO_TEST_CASE( test0_one_to_ten )
{
    ...
    typedef riakboost::mpl::range_c<int,0,10> one_to_ten;
    ut::unit_test_log.set_stream( null_output );
...
BOOST_AUTO_TEST_CASE( test1_one_to_five )
{
    ...
    typedef riakboost::mpl::range_c<int,1,5> one_to_five;
    ut::unit_test_log.set_stream( null_output );
...
BOOST_AUTO_TEST_CASE( test2_one_to_three )
{
    ...
    typedef riakboost::mpl::range_c<int,1,3> one_to_three;
    ut::unit_test_log.set_stream( null_output );
