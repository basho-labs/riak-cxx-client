...
typedef riakboost::mpl::vector<int,float,char> test_types;
...
typedef riakboost::mpl::vector<int,float,char,double,int> test_types;
...
{
    riakboost::shared_ptr<A> instA( new A );
    ...
    riakboost::shared_ptr<B> instB( new B );
    ...
    riakboost::shared_ptr<C> instC1( new D );
    ...
    riakboost::shared_ptr<C> instC2( new E );
