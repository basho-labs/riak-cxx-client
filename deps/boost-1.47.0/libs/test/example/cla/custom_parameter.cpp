...
namespace rt  = riakboost::runtime;
namespace cla = riakboost::runtime::cla;
...
struct Point : std::pair<int,int> {
    bool parse( rt::cstring& in ) {
        ...
        try {
            first  = riakboost::lexical_cast<int>( f );
            second = riakboost::lexical_cast<int>( s );
        }
        catch( riakboost::bad_lexical_cast const& ) {
            return false;
        }
...
struct Circle : std::pair<Point,int> {
    bool parse( rt::cstring& in ) {
        ...
        try {
            second = riakboost::lexical_cast<int>( ss );
        }
        catch( riakboost::bad_lexical_cast const& ) {
            return false;
        }
...
public:
    ...
    : cla::identification_policy( riakboost::rtti::type_id<ShapeIdPolicy<T> >() )
    , m_name( name ) {}
...
inline riakboost::shared_ptr<SegmentParam>
segment_param() { return riakboost::shared_ptr<SegmentParam>( new SegmentParam ); }
...
inline riakboost::shared_ptr<CircleParam>
circle_param() { return riakboost::shared_ptr<CircleParam>( new CircleParam ); }
...
int main() {
    ...
    try {
        ...
        riakboost::optional<std::list<Segment> > segments;
        riakboost::optional<std::list<Circle> > circles;
