...
template<typename T>
inline std::ostream&
operator<<( std::ostream& ostr, riakboost::optional<T> const& v )
{
    if( v )
        ostr << *v;
...
int main() {
    {
        ...
        try {
            ...
            riakboost::optional<int> v = P.get<riakboost::optional<int> >( "abcd" );
    ...
    }
    {
        ...
        try {
            ...
            typedef std::list<riakboost::optional<int> > value_type;
            value_type v = P.get<value_type>( "abcd" );

            std::cout << "*******\n""abcd = ";
            std::copy( v.begin(), v.end(), std::ostream_iterator<riakboost::optional<int> >( std::cout, ", " ) );
            std::cout << std::endl;
        }
        catch( rt::logic_error const& ex ) {
            std::cout << "Logic error: " << ex.msg() << std::endl;
