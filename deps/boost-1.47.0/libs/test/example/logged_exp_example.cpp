...
using namespace riakboost::itest;
...
// Collaborators mocks
class MockStove : public ::riakboost::itest::mock_object<0,Stove> {
public:
    virtual void    light()
    {
...
class MockMicrowave : public ::riakboost::itest::mock_object<0,Microwave> {
public:
...
class MockTimer : public ::riakboost::itest::mock_object<0,Timer> {
public:
