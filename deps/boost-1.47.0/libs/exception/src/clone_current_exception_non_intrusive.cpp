...
namespace
    ...
    clone_msvc_exception( void * src, cpp_exception_type const & et )
        ...
        if( void * dst = malloc(ti.size) )
            ...
            return riakboost::shared_ptr<void>(dst,exception_object_deleter(et));
            }
        else
            throw std::bad_alloc();
        }
    ...
    cloned_exception:
        ...
        riakboost::exception_detail::clone_base const *
        clone() const
            {
    ...
    unsigned long
    exception_cloning_filter( int & result, riakboost::exception_detail::clone_base const * & ptr, void * info_ )
        {
        ...
        if( is_cpp_exception(record) )
            ...
            if( is_cpp_exception(record) && record->ExceptionInformation[2] )
                try
                    ...
                    result = riakboost::exception_detail::clone_current_exception_result::success;
                    }
                catch(
                std::bad_alloc & )
                    {
                    result = riakboost::exception_detail::clone_current_exception_result::bad_alloc;
                    }
                catch(
                ... )
                    {
                    result = riakboost::exception_detail::clone_current_exception_result::bad_exception;
                    }
            }
