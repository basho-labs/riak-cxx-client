...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    void riakboosttss_cleanup_implemented() {}
}
...
namespace {
    void NTAPI on_tls_callback(void* h, DWORD dwReason, PVOID pv)
    {
        ...
        {
            riakboost::riakbooston_thread_exit();
            break;
        }
        }
    }
...
extern "C" {
    ...
    void (* after_ctors )() __attribute__((section(".ctors")))     = riakboost::riakbooston_process_enter;
    void (* before_dtors)() __attribute__((section(".dtors")))     = riakboost::riakbooston_thread_exit;
    void (* after_dtors )() __attribute__((section(".dtors.zzz"))) = riakboost::riakbooston_process_exit;
...
#pragma warning(pop)
        ...
        {
            //Schedule riakbooston_thread_exit() to be called for the main
            ...
            atexit(riakboost::riakbooston_thread_exit);

            //Call Boost process entry callback here

            riakboost::riakbooston_process_enter();
        ...
        {
            riakboost::riakbooston_process_exit();
            return INIRETSUCCESS;
        }
...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    void riakboosttss_cleanup_implemented()
    {
        ...
        riakboosttss_cleanup_implemented() function to eliminate the linker's
