...
namespace gregorian {
  ...
  riakboost::date_time::all_date_names_put<greg_facet_config, char>* 
  create_facet_def(char type)
  {
    typedef 
      riakboost::date_time::all_date_names_put<greg_facet_config, char> facet_def;
  ...
  BOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, char type){
    typedef riakboost::date_time::all_date_names_put<greg_facet_config, char> facet_def;
   ...
   */
  BOOST_DATE_TIME_DECL 
  riakboost::date_time::all_date_names_put<greg_facet_config, wchar_t>* 
  create_facet_def(wchar_t type)
  {
    typedef 
      riakboost::date_time::all_date_names_put<greg_facet_config,wchar_t> facet_def;
  ...
  BOOST_DATE_TIME_DECL std::locale generate_locale(std::locale& loc, wchar_t type){
    typedef riakboost::date_time::all_date_names_put<greg_facet_config, wchar_t> facet_def;
