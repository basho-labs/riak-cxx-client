...
struct is_class_or_union
{
   BOOST_STATIC_CONSTANT(bool, value =
      (::riakboost::type_traits::ice_or<
           ::riakboost::is_class<T>::value
         , ::riakboost::is_union<T>::value
      >::value));
};
...
# else
    template <class U> static ::riakboost::type_traits::yes_type is_class_or_union_tester(void(U::*)(void));

#  if BOOST_WORKAROUND(BOOST_MSVC, == 1300)                 \
    || BOOST_WORKAROUND(__MWERKS__, <= 0x3000) // no SFINAE
    static ::riakboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester(0)) == sizeof(::riakboost::type_traits::yes_type));
#  else
    template <class U>
    static ::riakboost::type_traits::no_type is_class_or_union_tester(...);
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(is_class_or_union_tester<T>(0)) == sizeof(::riakboost::type_traits::yes_type));
#  endif
# endif
};
#endif
...
{
    template <typename T> struct type
       : public ::riakboost::is_convertible<typename riakboost::add_reference<T>::type,::riakboost::detail::int_convertible>
    {
    };
};
...
{
   //typedef ::riakboost::add_reference<T> ar_t;
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
      (::riakboost::type_traits::ice_or<
           ::riakboost::is_arithmetic<T>::value
         , ::riakboost::is_reference<T>::value
         , ::riakboost::is_function<T>::value
   ...
   BOOST_STATIC_CONSTANT(bool, selector =
    ...
    typedef ::riakboost::detail::is_enum_helper<
          ::riakboost::detail::is_enum_impl<T>::selector
        > se_t;
#else
    typedef ::riakboost::detail::is_enum_helper<selector> se_t;
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_enum,T,::riakboost::detail::is_enum_impl<T>::value)
