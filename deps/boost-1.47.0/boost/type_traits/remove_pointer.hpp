...
namespace detail{
   ...
   {
      typedef typename remove_pointer_imp<typename riakboost::remove_cv<T>::type>::type type;
   };
   ...
   {
      typedef typename remove_pointer_imp3<T, ::riakboost::is_pointer<T>::value>::type type;
   };
}

BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename riakboost::detail::remove_pointer_imp2<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_pointer,T,typename riakboost::detail::remove_pointer_impl<T>::type)
