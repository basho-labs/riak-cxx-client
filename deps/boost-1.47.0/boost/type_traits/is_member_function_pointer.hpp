...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(
    ...
    , T
    , ::riakboost::type_traits::is_mem_fun_pointer_impl<typename remove_cv<T>::type>::value
    )
...
#pragma warning(disable:6334)
        ...
        BOOST_STATIC_CONSTANT(
            bool, value = (
                1 == sizeof(::riakboost::type_traits::is_mem_fun_pointer_tester(self_type::make_t))
            ));
#if BOOST_WORKAROUND(BOOST_MSVC_FULL_VER, >= 140050000)
#pragma warning(pop)
#endif
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_function_pointer,T,::riakboost::detail::is_member_function_pointer_impl<T>::value)
