...
namespace type_traits_detail {
    ...
    { 
       typedef typename riakboost::type_traits_detail::add_rvalue_reference_helper
                  <T, (!is_void<T>::value && !is_reference<T>::value) >::type type; 
    };

}

BOOST_TT_AUX_TYPE_TRAIT_DEF1(add_rvalue_reference,T,typename riakboost::type_traits_detail::add_rvalue_reference_imp<T>::type)
