...
struct function_traits : 
  public riakboost::detail::function_traits_helper<typename riakboost::add_pointer<Function>::type>
{
};
...
struct function_traits
{
  BOOST_STATIC_CONSTANT(unsigned, arity = (sizeof(riakboost::detail::function_arity_helper((Function*)0))-1));
};
