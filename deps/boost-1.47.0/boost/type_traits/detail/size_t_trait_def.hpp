...
#   define BOOST_TT_AUX_SIZE_T_BASE(C) public ::riakboost::integral_constant<std::size_t,C>
#   define BOOST_TT_AUX_SIZE_T_TRAIT_VALUE_DECL(C) /**/
#else
#   define BOOST_TT_AUX_SIZE_T_BASE(C) public ::riakboost::mpl::size_t<C>
#   define BOOST_TT_AUX_SIZE_T_TRAIT_VALUE_DECL(C) \
    typedef ::riakboost::mpl::size_t<C> base_; \
    using base_::value; \
    /**/
#endif
