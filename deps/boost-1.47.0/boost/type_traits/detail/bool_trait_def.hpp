...
#   define BOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(C) \
    typedef ::riakboost::integral_constant<bool,C> type; \
...
#   define BOOST_TT_AUX_BOOL_TRAIT_VALUE_DECL(C) \
    typedef ::riakboost::integral_constant<bool,C> base_; \
    using base_::value; \
    /**/
...
#   define BOOST_TT_AUX_BOOL_C_BASE(C) : public ::riakboost::integral_constant<bool,C>
#endif 
