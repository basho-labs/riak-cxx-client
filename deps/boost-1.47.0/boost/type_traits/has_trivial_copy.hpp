...
struct has_trivial_copy_impl
{
   ...
   BOOST_STATIC_CONSTANT(bool, value =
      (::riakboost::type_traits::ice_and<
         ::riakboost::is_pod<T>::value,
         ::riakboost::type_traits::ice_not< ::riakboost::is_volatile<T>::value >::value
      >::value));
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy,T,::riakboost::detail::has_trivial_copy_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_copy_constructor,T,::riakboost::detail::has_trivial_copy_impl<T>::value)
