...
{ 
    BOOST_STATIC_CONSTANT(
        ...
        (::riakboost::type_traits::ice_or<
            ::riakboost::is_scalar<T>::value,
            ::riakboost::is_void<T>::value,
...
{
    typedef ::riakboost::type_traits::no_type type;
};

template <>
struct bool_to_yes_no_type<true>
{
    typedef ::riakboost::type_traits::yes_type type;
};

template <typename ArrayType>
struct is_pod_array_helper
{
    enum { is_pod = ::riakboost::is_POD<ArrayType>::value }; // MSVC workaround
...
struct is_pod_helper<true>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value =
            sizeof(is_POD_array(help()).instance()) == sizeof(::riakboost::type_traits::yes_type)
            );
    };
};
...
{ 
   BOOST_STATIC_CONSTANT(
       bool, value = (
           ::riakboost::detail::is_pod_helper<
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_POD,T,::riakboost::detail::is_pod_impl<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pod,T,::riakboost::detail::is_pod_impl<T>::value)
