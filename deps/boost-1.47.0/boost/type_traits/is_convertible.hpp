...
using ::riakboost::type_traits::yes_type;
using ::riakboost::type_traits::no_type;
...
struct does_conversion_exist<void>
{
    template< typename To > struct result_
    {
        enum { value = ::riakboost::is_void<To>::value };
    };
};
...
#pragma option push -w-8074
    ...
    {
        static ::riakboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
        static ::riakboost::type_traits::yes_type BOOST_TT_DECL _m_check(T);
    };

    static typename add_rvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( checker<To>::_m_check(_m_from) )
        == sizeof(::riakboost::type_traits::yes_type);
#pragma option pop
};
...
template <typename T> struct checker
{
    static riakboost::type_traits::no_type _m_check(any_conversion ...);
    static riakboost::type_traits::yes_type _m_check(T, int);
};
...
{
    static typename add_rvalue_reference<From>::type  _m_from;
    static bool const value = sizeof( riakboost::detail::checker<To>::_m_check(_m_from, 0) )
        == sizeof(::riakboost::type_traits::yes_type);
};
...
struct is_convertible_basic_impl
{
    static ::riakboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion ...);
    static ::riakboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int);
    static typename add_rvalue_reference<From>::type  _m_from;

    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from, 0) ) == sizeof(::riakboost::type_traits::yes_type)
        );
};
...
struct is_convertible_basic_impl
{
    ...
    template <class T>
    static ::riakboost::type_traits::no_type BOOST_TT_DECL _m_check(any_conversion,  float, T);
    static ::riakboost::type_traits::yes_type BOOST_TT_DECL _m_check(To, int, int);
    static typename add_rvalue_reference<From>::type  _m_from;

    // Static constants sometime cause the conversion of _m_from to To to be
    // called. This doesn't happen with an enum.
    enum { value =
        sizeof( _m_check(_m_from, 0, 0) ) == sizeof(::riakboost::type_traits::yes_type)
        };
};
...
{
    static ::riakboost::type_traits::no_type BOOST_TT_DECL _m_check(...);
    static ::riakboost::type_traits::yes_type BOOST_TT_DECL _m_check(To);
    static typename add_rvalue_reference<From>::type  _m_from;
    BOOST_STATIC_CONSTANT(bool, value =
        sizeof( _m_check(_m_from) ) == sizeof(::riakboost::type_traits::yes_type)
        );
};
...
struct is_convertible_basic_impl:
  is_convertible_basic_impl_aux<
    From,To,
    ::riakboost::is_function<typename ::riakboost::remove_reference<From>::type>::value
  >
{};
...
struct is_convertible_impl
{
    ...
    enum { value =
        (::riakboost::type_traits::ice_and<
            ::riakboost::type_traits::ice_or<
               ::riakboost::detail::is_convertible_basic_impl<ref_type,To>::value,
               ::riakboost::is_void<To>::value
            >::value,
            ::riakboost::type_traits::ice_not<
               ::riakboost::is_array<To>::value
            >::value
        >::value) };
};
...
struct is_convertible_impl_dispatch_base
{
   ...
   typedef is_convertible_impl_select< 
      ::riakboost::is_arithmetic<From>::value, 
      ::riakboost::is_arithmetic<To>::value,
#ifndef BOOST_NO_IS_ABSTRACT
      ::riakboost::is_abstract<To>::value
#else
      false
#endif
   > selector;
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(is_convertible,From,To,(::riakboost::detail::is_convertible_impl_dispatch<From,To>::value))
