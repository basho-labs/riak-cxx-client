...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::riakboost::detail::cv_traits_imp<typename riakboost::remove_bounds<T>::type*>::is_volatile);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::riakboost::detail::cv_traits_imp<T*>::is_volatile);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::riakboost::detail::is_volatile_rval_filter<T>::value)
...
struct is_volatile_helper<false,false>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(riakboost::detail::yes_type) == sizeof(riakboost::detail::is_volatile_tester(t))
            ));
    };
};
...
//* is a type T declared volatile - is_volatile<T>
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::riakboost::detail::is_volatile_impl<T>::value)
