...
{
   typedef typename remove_cv<T>::type no_cv_t;
   BOOST_STATIC_CONSTANT(bool, value = (!(::riakboost::detail::is_signed_values<T>::minus_one  > riakboost::detail::is_signed_values<T>::zero)));
};
...
#else
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_signed,T,::riakboost::detail::is_signed_imp<T>::value)
#endif
