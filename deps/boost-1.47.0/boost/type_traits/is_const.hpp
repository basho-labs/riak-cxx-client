...
{
#if BOOST_WORKAROUND(BOOST_MSVC, < 1400)
   BOOST_STATIC_CONSTANT(bool, value = ::riakboost::detail::cv_traits_imp<typename riakboost::remove_bounds<T>::type*>::is_const);
#else
   BOOST_STATIC_CONSTANT(bool, value = ::riakboost::detail::cv_traits_imp<T*>::is_const);
#endif
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::riakboost::detail::is_const_rvalue_filter<T>::value)
...
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T const,!(::riakboost::is_reference<T>::value))
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_const,T volatile const,!(::riakboost::is_reference<T>::value))
#endif
...
struct is_const_helper
    : public ::riakboost::type_traits::false_result
{
};
...
struct is_const_helper<false,false>
{
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(bool, value = (
            sizeof(riakboost::detail::yes_type) == sizeof(riakboost::detail::is_const_tester(t))
            ));
    };
};
...
//* is a type T  declared const - is_const<T>
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_const,T,::riakboost::detail::is_const_impl<T>::value)
