...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_reference,T,typename riakboost::detail::remove_rvalue_ref<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_reference,T,typename riakboost::detail::remove_reference_impl<T>::type)
