...
// types.
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const ,::riakboost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T volatile ,::riakboost::is_lvalue_reference<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_lvalue_reference,T const volatile ,::riakboost::is_lvalue_reference<T>::value)
...
using ::riakboost::type_traits::wrap;
...
struct is_lvalue_reference_impl
{
    BOOST_STATIC_CONSTANT(
        bool, value = sizeof(
            ::riakboost::detail::is_lvalue_reference_helper2(
                ::riakboost::detail::is_lvalue_reference_helper1(::riakboost::type_traits::wrap<T>()))) == 1
        );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_lvalue_reference,T,::riakboost::detail::is_lvalue_reference_impl<T>::value)
