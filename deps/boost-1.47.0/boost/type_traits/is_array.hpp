...
{ 
    BOOST_STATIC_CONSTANT(bool, value = 
        sizeof(::riakboost::detail::is_array_tester2(
            ::riakboost::detail::is_array_tester1(
                ::riakboost::type_traits::wrap<T>()
                )
        )) == 1
    );
};
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_array,T,::riakboost::detail::is_array_impl<T>::value)
