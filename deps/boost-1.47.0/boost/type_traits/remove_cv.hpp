...
{
   typedef typename riakboost::detail::cv_traits_imp<T*>::unqualified_type type;
};
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_cv,T,typename riakboost::detail::rvalue_ref_filter_rem_cv<T>::type)
...
BOOST_TT_AUX_TYPE_TRAIT_DEF1(remove_cv,T,typename riakboost::detail::remove_cv_impl<T>::type)
