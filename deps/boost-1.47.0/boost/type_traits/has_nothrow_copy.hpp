...
#else
   BOOST_STATIC_CONSTANT(bool, value = ::riakboost::has_trivial_copy<T>::value);
#endif
};

}

BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_copy,T,::riakboost::detail::has_nothrow_copy_imp<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_DEF1(has_nothrow_copy_constructor,T,::riakboost::detail::has_nothrow_copy_imp<T>::value)
