...
struct is_pointer_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value =
        (::riakboost::type_traits::ice_and<
              ::riakboost::detail::is_pointer_helper<T>::value
            , ::riakboost::type_traits::ice_not<
                ::riakboost::is_member_pointer<T>::value
                >::value
            >::value)
        );
#else
    BOOST_STATIC_CONSTANT(bool, value =
        (::riakboost::type_traits::ice_and<
        ::riakboost::detail::is_pointer_helper<typename remove_cv<T>::type>::value
            , ::riakboost::type_traits::ice_not<
                ::riakboost::is_member_pointer<T>::value
                >::value
            >::value)
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_pointer,T,::riakboost::detail::is_pointer_impl<T>::value)
