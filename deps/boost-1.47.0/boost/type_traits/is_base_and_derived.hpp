...
{
    BOOST_STATIC_CONSTANT(bool, value =
        (::riakboost::is_convertible<D*,B*>::value));
};
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::riakboost::is_class<B>::value,
       ::riakboost::is_class<D>::value,
       ::riakboost::is_same<ncvB,ncvD>::value> selector;
...
struct is_base_and_derived_impl
{
    ...
    BOOST_STATIC_CONSTANT(bool, value = (BOOST_IS_BASE_OF(B,D) && ! ::riakboost::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
BOOST_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::riakboost::detail::is_base_and_derived_impl<Base,Derived>::value)
    )
