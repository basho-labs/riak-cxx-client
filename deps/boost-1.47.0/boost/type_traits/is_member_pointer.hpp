...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_pointer,T,::riakboost::is_member_function_pointer<T>::value)
BOOST_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_2(typename T,typename U,is_member_pointer,U T::*,true)
...
::riakboost::type_traits::yes_type BOOST_TT_DECL is_member_pointer_tester(R T::*const volatile*);
::riakboost::type_traits::no_type BOOST_TT_DECL is_member_pointer_tester(...);
    ...
    template <typename T> struct result_
    {
        ...
        BOOST_STATIC_CONSTANT(
            ...
            (::riakboost::type_traits::ice_or<
                (1 == sizeof(::riakboost::type_traits::is_mem_fun_pointer_tester(make_t()))),
...
BOOST_TT_AUX_BOOL_TRAIT_DEF1(is_member_pointer,T,::riakboost::detail::is_member_pointer_impl<T>::value)
