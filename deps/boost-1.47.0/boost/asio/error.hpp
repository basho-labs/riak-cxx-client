...
inline const riakboost::system::error_category& get_system_category()
{
  return riakboost::system::system_category();
}

#if !defined(BOOST_WINDOWS) && !defined(__CYGWIN__)

extern BOOST_ASIO_DECL
const riakboost::system::error_category& get_netdb_category();

extern BOOST_ASIO_DECL
const riakboost::system::error_category& get_addrinfo_category();

#else // !defined(BOOST_WINDOWS) && !defined(__CYGWIN__)

inline const riakboost::system::error_category& get_netdb_category()
{
  return get_system_category();
}

inline const riakboost::system::error_category& get_addrinfo_category()
{
  return get_system_category();
}
...
extern BOOST_ASIO_DECL
const riakboost::system::error_category& get_misc_category();

static const riakboost::system::error_category& system_category
  = riakboost::asio::error::get_system_category();
static const riakboost::system::error_category& netdb_category
  = riakboost::asio::error::get_netdb_category();
static const riakboost::system::error_category& addrinfo_category
  = riakboost::asio::error::get_addrinfo_category();
static const riakboost::system::error_category& misc_category
  = riakboost::asio::error::get_misc_category();
...
template<> struct is_error_code_enum<riakboost::asio::error::basic_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<riakboost::asio::error::netdb_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<riakboost::asio::error::addrinfo_errors>
{
  static const bool value = true;
};

template<> struct is_error_code_enum<riakboost::asio::error::misc_errors>
{
  static const bool value = true;
};
...
inline riakboost::system::error_code make_error_code(netdb_errors e)
{
  return riakboost::system::error_code(
      static_cast<int>(e), get_netdb_category());
}

inline riakboost::system::error_code make_error_code(addrinfo_errors e)
{
  return riakboost::system::error_code(
      static_cast<int>(e), get_addrinfo_category());
}

inline riakboost::system::error_code make_error_code(misc_errors e)
{
  return riakboost::system::error_code(
