    ...
    const char* object_type, void* object, const char* op_name)
{
  ...
  riakboost::posix_time::ptime epoch(riakboost::gregorian::date(1970, 1, 1));
  riakboost::posix_time::time_duration now =
    riakboost::posix_time::microsec_clock::universal_time() - epoch;

  riakboost::uint64_t current_id = 0;
...
#endif // defined(BOOST_WINDOWS)
      static_cast<riakboost::uint64_t>(now.total_seconds()),
      static_cast<riakboost::uint64_t>(now.total_microseconds() % 1000000),
...
#endif // defined(BOOST_WINDOWS)
      static_cast<riakboost::uint64_t>(now.total_seconds()),
      static_cast<riakboost::uint64_t>(now.total_microseconds() % 1000000), id_);

  invoked_ = true;
}

void handler_tracking::completion::invocation_begin(
    const riakboost::system::error_code& ec)
{
  riakboost::posix_time::ptime epoch(riakboost::gregorian::date(1970, 1, 1));
  riakboost::posix_time::time_duration now =
    riakboost::posix_time::microsec_clock::universal_time() - epoch;
...
void handler_tracking::completion::invocation_begin(
    const riakboost::system::error_code& ec, std::size_t bytes_transferred)
{
  riakboost::posix_time::ptime epoch(riakboost::gregorian::date(1970, 1, 1));
  riakboost::posix_time::time_duration now =
    riakboost::posix_time::microsec_clock::universal_time() - epoch;
  ...
  write_line(
      ...
      static_cast<riakboost::uint64_t>(now.total_microseconds() % 1000000),
      id_, ec.category().name(), ec.value(),
      static_cast<riakboost::uint64_t>(bytes_transferred));

  invoked_ = true;
}

void handler_tracking::completion::invocation_begin(
    const riakboost::system::error_code& ec, int signal_number)
{
  riakboost::posix_time::ptime epoch(riakboost::gregorian::date(1970, 1, 1));
  riakboost::posix_time::time_duration now =
    riakboost::posix_time::microsec_clock::universal_time() - epoch;
...
void handler_tracking::completion::invocation_begin(
    const riakboost::system::error_code& ec, const char* arg)
{
  riakboost::posix_time::ptime epoch(riakboost::gregorian::date(1970, 1, 1));
  riakboost::posix_time::time_duration now =
    riakboost::posix_time::microsec_clock::universal_time() - epoch;
