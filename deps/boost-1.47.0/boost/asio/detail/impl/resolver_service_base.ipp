...
{
public:
  work_io_service_runner(riakboost::asio::io_service& io_service)
...
resolver_service_base::resolver_service_base(
  ...
  : io_service_impl_(riakboost::asio::use_service<io_service_impl>(io_service)),
    work_io_service_(new riakboost::asio::io_service),
    work_io_service_impl_(riakboost::asio::use_service<
        io_service_impl>(*work_io_service_)),
    work_(new riakboost::asio::io_service::work(*work_io_service_)),
    work_thread_(0)
{
}
    ...
    riakboost::asio::io_service::fork_event fork_ev)
{
  if (work_thread_.get())
  {
    ...
    {
      work_io_service_->reset();
      work_thread_.reset(new riakboost::asio::detail::thread(
