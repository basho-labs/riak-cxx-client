...
task_io_service::task_io_service(riakboost::asio::io_service& io_service)
  : riakboost::asio::detail::service_base<task_io_service>(io_service),
    mutex_(),
    task_(0),
...
std::size_t task_io_service::run(riakboost::system::error_code& ec)
{
...
std::size_t task_io_service::run_one(riakboost::system::error_code& ec)
{
  ec = riakboost::system::error_code();
  if (outstanding_work_ == 0)
  {
...
std::size_t task_io_service::poll(riakboost::system::error_code& ec)
{
  if (outstanding_work_ == 0)
  {
    stop();
...
std::size_t task_io_service::poll_one(riakboost::system::error_code& ec)
{
  ec = riakboost::system::error_code();
  if (outstanding_work_ == 0)
  {
