...
{
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  ec = riakboost::system::error_code(WSAGetLastError(),
      riakboost::asio::error::get_system_category());
#else
  ec = riakboost::system::error_code(errno,
      riakboost::asio::error::get_system_category());
#endif
  return return_value;
}
...
socket_type accept(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
socket_type sync_accept(socket_type s, state_type state,
    socket_addr_type* addr, std::size_t* addrlen, riakboost::system::error_code& ec)
{
  // Accept a socket.
  for (;;)
  {
    ...
    else if (ec == riakboost::asio::error::connection_aborted)
    {
...
void complete_iocp_accept(socket_type s,
    ...
    socket_type new_socket, riakboost::system::error_code& ec)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = riakboost::asio::error::connection_aborted;
  ...
  if (!ec)
  {
    ...
    if (addr && addrlen)
    {
      ...
      {
        ec = riakboost::asio::error::invalid_argument;
      }
      else
      {
...
bool non_blocking_accept(socket_type s,
    ...
    riakboost::system::error_code& ec, socket_type& new_socket)
{
  for (;;)
  {
...
int close(socket_type s, state_type& state,
    bool destruction, riakboost::system::error_code& ec)
{
  int result = 0;
  if (s != invalid_socket)
  {
    ...
    if (destruction && (state & user_set_linger))
    {
      ...
      opt.l_onoff = 0;
      opt.l_linger = 0;
      riakboost::system::error_code ignored_ec;
    ...
    if (result != 0
        && (ec == riakboost::asio::error::would_block
          || ec == riakboost::asio::error::try_again))
    {
...
bool set_user_non_blocking(socket_type s,
    state_type& state, bool value, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int shutdown(socket_type s, int what, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
    ...
    std::size_t addrlen, riakboost::system::error_code& ec)
{
  ...
  if (ec != riakboost::asio::error::in_progress
      && ec != riakboost::asio::error::would_block)
  {
  ...
  ec = riakboost::system::error_code(connect_error,
      riakboost::asio::error::get_system_category());
}

bool non_blocking_connect(socket_type s, riakboost::system::error_code& ec)
{
  // Get the error code from the connect operation.
  int connect_error = 0;
  size_t connect_error_len = sizeof(connect_error);
...
int socketpair(int af, int type, int protocol,
    socket_type sv[2], riakboost::system::error_code& ec)
{
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  (void)(af);
  (void)(type);
  (void)(protocol);
  (void)(sv);
  ec = riakboost::asio::error::operation_not_supported;
  return socket_error_retval;
#else
  clear_last_error();
...
bool sockatmark(socket_type s, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
# if defined(ENOTTY)
  if (ec.value() == ENOTTY)
    ec = riakboost::asio::error::not_socket;
...
size_t available(socket_type s, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int listen(socket_type s, int backlog, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
    ...
    riakboost::system::error_code& ec)
{
  ...
  if (ec.value() == ERROR_NETNAME_DELETED)
    ec = riakboost::asio::error::connection_reset;
  else if (ec.value() == ERROR_PORT_UNREACHABLE)
    ec = riakboost::asio::error::connection_refused;
  if (result != 0)
    return socket_error_retval;
  ec = riakboost::system::error_code();
...
size_t sync_recv(socket_type s, state_type state, buf* bufs,
    size_t count, int flags, bool all_empty, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
void complete_iocp_recv(state_type state,
    ...
    riakboost::system::error_code& ec, size_t bytes_transferred)
{
  // Map non-portable errors to their portable counterparts.
  if (ec.value() == ERROR_NETNAME_DELETED)
  {
    if (cancel_token.expired())
      ec = riakboost::asio::error::operation_aborted;
    else
      ec = riakboost::asio::error::connection_reset;
  }
  else if (ec.value() == ERROR_PORT_UNREACHABLE)
...
int recvmsg(socket_type s, buf* bufs, size_t count,
    int in_flags, int& out_flags, riakboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  out_flags = 0;
...
int setsockopt(socket_type s, state_type& state, int level, int optname,
    const void* optval, std::size_t optlen, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int getsockopt(socket_type s, state_type state, int level, int optname,
    void* optval, size_t* optlen, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int getpeername(socket_type s, socket_addr_type* addr,
    std::size_t* addrlen, bool cached, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
  ...
  if (cached)
  {
    ...
    {
      ec = riakboost::asio::error::not_connected;
      return socket_error_retval;
    }
...
int ioctl(socket_type s, state_type& state, int cmd,
    ioctl_arg_type* arg, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int select(int nfds, fd_set* readfds, fd_set* writefds,
    fd_set* exceptfds, timeval* timeout, riakboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  ...
  // system clock (as wrapped by riakboost::posix_time::microsec_clock) typically
...
int poll_read(socket_type s, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int poll_write(socket_type s, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
int poll_connect(socket_type s, riakboost::system::error_code& ec)
{
  if (s == invalid_socket)
  {
    ec = riakboost::asio::error::bad_descriptor;
...
const char* inet_ntop(int af, const void* src, char* dest, size_t length,
    unsigned long scope_id, riakboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  using namespace std; // For memcpy.
  ...
  {
    ec = riakboost::asio::error::address_family_not_supported;
    return 0;
  }
...
int gethostname(char* name, int namelen, riakboost::system::error_code& ec)
{
  clear_last_error();
...
inline riakboost::system::error_code translate_netdb_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case HOST_NOT_FOUND:
    return riakboost::asio::error::host_not_found;
  case TRY_AGAIN:
    return riakboost::asio::error::host_not_found_try_again;
  case NO_RECOVERY:
    return riakboost::asio::error::no_recovery;
  case NO_DATA:
    return riakboost::asio::error::no_data;
  default:
    BOOST_ASSERT(false);
    return riakboost::asio::error::invalid_argument;
  }
}

inline hostent* gethostbyaddr(const char* addr, int length, int af,
    hostent* result, char* buffer, int buflength, riakboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
...
inline hostent* gethostbyname(const char* name, int af, struct hostent* result,
    char* buffer, int buflength, int ai_flags, riakboost::system::error_code& ec)
{
  clear_last_error();
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
  (void)(buffer);
    ...
    const addrinfo_type* hintsp, addrinfo_type** result)
{
  ...
  for (gai_search* sptr = search; sptr < search + search_count; ++sptr)
  {
    ...
    if (hptr == 0)
    {
      ...
      freeaddrinfo_emulation(aihead);
      gai_free(canon);
      if (ec == riakboost::asio::error::host_not_found)
        return EAI_NONAME;
      if (ec == riakboost::asio::error::host_not_found_try_again)
        return EAI_AGAIN;
      if (ec == riakboost::asio::error::no_recovery)
        return EAI_FAIL;
      if (ec == riakboost::asio::error::no_data)
        return EAI_NONAME;
      return EAI_NONAME;
    }
...
inline riakboost::system::error_code getnameinfo_emulation(
    ...
    riakboost::system::error_code& ec)
{
  ...
  case AF_INET:
    ...
    {
      return ec = riakboost::asio::error::invalid_argument;
    }
  ...
  case AF_INET6:
    ...
    break;
  default:
    return ec = riakboost::asio::error::address_family_not_supported;
  }
  ...
  if (host && hostlen > 0)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        {
          return ec = riakboost::asio::error::host_not_found;
        }
  ...
  if (serv && servlen > 0)
  {
    if (flags & NI_NUMERICSERV)
    {
      if (servlen < 6)
      {
        return ec = riakboost::asio::error::no_buffer_space;
      }
#if BOOST_WORKAROUND(BOOST_MSVC, >= 1400) && !defined(UNDER_CE)
...
inline riakboost::system::error_code translate_addrinfo_error(int error)
{
  switch (error)
  {
  case 0:
  ...
  case EAI_FAIL:
    return riakboost::asio::error::no_recovery;
  case EAI_FAMILY:
    return riakboost::asio::error::address_family_not_supported;
  case EAI_MEMORY:
    return riakboost::asio::error::no_memory;
  case EAI_NONAME:
  ...
  case EAI_NODATA:
    ...
    return riakboost::asio::error::host_not_found;
  case EAI_SERVICE:
    return riakboost::asio::error::service_not_found;
  case EAI_SOCKTYPE:
    return riakboost::asio::error::socket_type_not_supported;
  default: // Possibly the non-portable EAI_SYSTEM.
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
    return riakboost::system::error_code(
        WSAGetLastError(), riakboost::asio::error::get_system_category());
#else
    return riakboost::system::error_code(
        errno, riakboost::asio::error::get_system_category());
#endif
  }
}

riakboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, riakboost::system::error_code& ec)
{
...
riakboost::system::error_code background_getaddrinfo(
...
riakboost::system::error_code getnameinfo(const socket_addr_type* addr,
    std::size_t addrlen, char* host, std::size_t hostlen,
    char* serv, std::size_t servlen, int flags, riakboost::system::error_code& ec)
{
#if defined(BOOST_WINDOWS) || defined(__CYGWIN__)
# if defined(_WIN32_WINNT) && (_WIN32_WINNT >= 0x0501) || defined(UNDER_CE)
  // Building for Windows XP, Windows Server 2003, or later.
...
riakboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, riakboost::system::error_code& ec)
{
...
riakboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, riakboost::system::error_code& ec)
