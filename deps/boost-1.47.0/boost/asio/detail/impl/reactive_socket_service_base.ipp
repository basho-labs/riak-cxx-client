...
riakboost::system::error_code reactive_socket_service_base::close(
    reactive_socket_service_base::base_implementation_type& impl,
...
riakboost::system::error_code reactive_socket_service_base::cancel(
    reactive_socket_service_base::base_implementation_type& impl,
    riakboost::system::error_code& ec)
{
  if (!is_open(impl))
...
riakboost::system::error_code reactive_socket_service_base::do_open(
    reactive_socket_service_base::base_implementation_type& impl,
    int af, int type, int protocol, riakboost::system::error_code& ec)
{
  if (is_open(impl))
  {
  ...
  {
    ec = riakboost::system::error_code(err,
...
riakboost::system::error_code reactive_socket_service_base::do_assign(
    ...
    reactor_op* op, bool peer_is_open)
{
  ...
  {
    op->ec_ = riakboost::asio::error::already_open;
    reactor_.post_immediate_completion(op);
  }
}
