...
select_reactor::select_reactor(riakboost::asio::io_service& io_service)
  : riakboost::asio::detail::service_base<select_reactor>(io_service),
...
{
#if defined(BOOST_ASIO_HAS_IOCP)
  riakboost::asio::detail::signal_blocker sb;
  thread_ = new riakboost::asio::detail::thread(
...
void select_reactor::fork_service(riakboost::asio::io_service::fork_event fork_ev)
{
