...
public:
  ...
  // Constructor.
  win_iocp_socket_service(riakboost::asio::io_service& io_service)
  ...
  riakboost::system::error_code set_option(implementation_type& impl,
      const Option& option, riakboost::system::error_code& ec)
  {
  ...
  riakboost::system::error_code get_option(const implementation_type& impl,
      Option& option, riakboost::system::error_code& ec) const
  {
  ...
  riakboost::system::error_code accept(implementation_type& impl, Socket& peer,
      endpoint_type* peer_endpoint, riakboost::system::error_code& ec)
  {
    // We cannot accept a socket that is already open.
    if (peer.is_open())
    {
      ec = riakboost::asio::error::already_open;
      return ec;
    }
