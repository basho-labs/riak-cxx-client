...
class consuming_buffers_iterator
  : public riakboost::iterator<std::forward_iterator_tag, const Buffer>
{
public:
...
class consuming_buffers<Buffer, riakboost::asio::null_buffers>
  : public riakboost::asio::null_buffers
{
public:
  consuming_buffers(const riakboost::asio::null_buffers&)
  {
    // No-op.
  }
