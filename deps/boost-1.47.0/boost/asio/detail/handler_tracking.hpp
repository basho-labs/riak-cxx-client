...
public:
  ...
  public:
    ...
    BOOST_ASIO_DECL void invocation_begin(const riakboost::system::error_code& ec);
...
# define BOOST_ASIO_INHERIT_TRACKED_HANDLER \
  : public riakboost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_ALSO_INHERIT_TRACKED_HANDLER \
  , public riakboost::asio::detail::handler_tracking::tracked_handler

# define BOOST_ASIO_HANDLER_TRACKING_INIT \
  riakboost::asio::detail::handler_tracking::init()

# define BOOST_ASIO_HANDLER_CREATION(args) \
  riakboost::asio::detail::handler_tracking::creation args

# define BOOST_ASIO_HANDLER_COMPLETION(args) \
  riakboost::asio::detail::handler_tracking::completion tracked_completion args
...
# define BOOST_ASIO_HANDLER_OPERATION(args) \
  riakboost::asio::detail::handler_tracking::operation args
