...
public:
  void complete(win_iocp_io_service& owner,
      const riakboost::system::error_code& ec = riakboost::system::error_code(),
  ...
  void destroy()
  {
    func_(0, this, riakboost::system::error_code(), 0);
  }

protected:
  typedef void (*func_type)(win_iocp_io_service*,
      win_iocp_operation*, riakboost::system::error_code, std::size_t);
