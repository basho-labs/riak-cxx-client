...
class select_reactor
  : public riakboost::asio::detail::service_base<select_reactor>
{
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL select_reactor(riakboost::asio::io_service& io_service);
...
private:
  ...
  riakboost::asio::detail::thread* thread_;
#endif // defined(BOOST_ASIO_HAS_IOCP)
