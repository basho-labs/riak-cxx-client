...
#define BOOST_ASIO_COMPLETION_HANDLER_CHECK( \
  ...
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(riakboost::asio::detail::zero_arg_handler_test( \
          handler, 0)) == 1, \
      "CompletionHandler type requirements not met") \
  \
  typedef riakboost::asio::detail::handler_type_requirements< \
      sizeof( \
        riakboost::asio::detail::argbyv( \
          riakboost::asio::detail::clvref(handler))) + \
      sizeof( \
        riakboost::asio::detail::lvref(handler)(), \
        char(0))>
...
#define BOOST_ASIO_READ_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(riakboost::asio::detail::two_arg_handler_test( \
          handler, \
          static_cast<const riakboost::system::error_code*>(0), \
  ...
  typedef riakboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        riakboost::asio::detail::lvref(handler)( \
          riakboost::asio::detail::lvref<const riakboost::system::error_code>(), \
          riakboost::asio::detail::lvref<const std::size_t>()), \
        char(0))>
...
#define BOOST_ASIO_ACCEPT_HANDLER_CHECK( \
  ...
  \
  BOOST_ASIO_HANDLER_TYPE_REQUIREMENTS_ASSERT( \
      sizeof(riakboost::asio::detail::one_arg_handler_test( \
          handler, \
          static_cast<const riakboost::system::error_code*>(0))) == 1, \
...
#define BOOST_ASIO_COMPOSED_CONNECT_HANDLER_CHECK( \
  ...
  typedef riakboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        riakboost::asio::detail::lvref(handler)( \
          riakboost::asio::detail::lvref<const riakboost::system::error_code>(), \
          riakboost::asio::detail::lvref<const iter_type>()), \
        char(0))>
...
#define BOOST_ASIO_SIGNAL_HANDLER_CHECK( \
  ...
  typedef riakboost::asio::detail::handler_type_requirements< \
      ...
      sizeof( \
        riakboost::asio::detail::lvref(handler)( \
          riakboost::asio::detail::lvref<const riakboost::system::error_code>(), \
          riakboost::asio::detail::lvref<const int>()), \
        char(0))>
