...
public:
  ...
  // Constructor.
  BOOST_ASIO_DECL resolver_service_base(riakboost::asio::io_service& io_service);
  ...
  BOOST_ASIO_DECL void fork_service(
      riakboost::asio::io_service::fork_event fork_ev);
...
protected:
  ...
  class auto_addrinfo
    : private riakboost::asio::detail::noncopyable
  {
  public:
    explicit auto_addrinfo(riakboost::asio::detail::addrinfo_type* ai)
      : ai_(ai)
    {
    }
    ...
    operator riakboost::asio::detail::addrinfo_type*()
    {
      return ai_;
    }

  private:
    riakboost::asio::detail::addrinfo_type* ai_;
  };
...
private:
  ...
  riakboost::asio::detail::scoped_ptr<riakboost::asio::io_service> work_io_service_;

  // The work io_service implementation used to post completions.
  io_service_impl& work_io_service_impl_;

  // Work for the private io_service to perform.
  riakboost::asio::detail::scoped_ptr<riakboost::asio::io_service::work> work_;

  // Thread used for running the work io_service's run loop.
  riakboost::asio::detail::scoped_ptr<riakboost::asio::detail::thread> work_thread_;
};
