...
public:
  ...
  // Destroy a socket implementation.
  BOOST_ASIO_DECL riakboost::system::error_code close(
      base_implementation_type& impl, riakboost::system::error_code& ec);

  // Cancel all operations associated with the socket.
  BOOST_ASIO_DECL riakboost::system::error_code cancel(
      base_implementation_type& impl, riakboost::system::error_code& ec);
  ...
  riakboost::system::error_code listen(base_implementation_type& impl,
  ...
  riakboost::system::error_code io_control(base_implementation_type& impl,
      IO_Control_Command& command, riakboost::system::error_code& ec)
  {
  ...
  riakboost::system::error_code non_blocking(base_implementation_type& impl,
  ...
  riakboost::system::error_code native_non_blocking(base_implementation_type& impl,
      bool mode, riakboost::system::error_code& ec)
  {
  ...
  riakboost::system::error_code shutdown(base_implementation_type& impl,
  ...
  {
    buffer_sequence_adapter<riakboost::asio::const_buffer,
  ...
  size_t send(base_implementation_type& impl, const null_buffers&,
      socket_base::message_flags, riakboost::system::error_code& ec)
  {
  ...
  size_t receive(base_implementation_type& impl,
      ...
      socket_base::message_flags flags, riakboost::system::error_code& ec)
  {
    buffer_sequence_adapter<riakboost::asio::mutable_buffer,
  ...
  size_t receive_with_flags(base_implementation_type& impl,
      ...
      socket_base::message_flags& out_flags, riakboost::system::error_code& ec)
  {
    buffer_sequence_adapter<riakboost::asio::mutable_buffer,
        MutableBufferSequence> bufs(buffers);
...
protected:
  ...
  BOOST_ASIO_DECL riakboost::system::error_code do_open(
      base_implementation_type& impl, int family, int type,
      int protocol, riakboost::system::error_code& ec);

  // Assign a native socket to a socket implementation.
  BOOST_ASIO_DECL riakboost::system::error_code do_assign(
      base_implementation_type& impl, int type,
      socket_type native_socket, riakboost::system::error_code& ec);
  ...
  riakboost::asio::detail::mutex mutex_;
