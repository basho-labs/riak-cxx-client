...
public:
  ...
  typedef riakboost::asio::ip::basic_resolver_query<Protocol> query_type;
  typedef riakboost::asio::ip::basic_resolver_iterator<Protocol> iterator_type;
      ...
      riakboost::system::error_code /*ec*/, std::size_t /*bytes_transferred*/)
  {
    ...
    ptr p = { riakboost::addressof(o->handler_), o, o };
    ...
    else
    {
      ...
      detail::binder2<Handler, riakboost::system::error_code, iterator_type>
...
private:
  ...
  riakboost::asio::detail::addrinfo_type* addrinfo_;
};
