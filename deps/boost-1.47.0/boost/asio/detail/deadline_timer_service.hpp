...
public:
  ...
  // Constructor.
  deadline_timer_service(riakboost::asio::io_service& io_service)
    : scheduler_(riakboost::asio::use_service<timer_scheduler>(io_service))
  {
  ...
  void wait(implementation_type& impl, riakboost::system::error_code& ec)
  {
    ...
    {
      riakboost::posix_time::time_duration timeout =
