...
BOOST_ASIO_DECL int shutdown(socket_type s,
    int what, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL bool non_blocking_connect(
    socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL int socketpair(int af, int type, int protocol,
    socket_type sv[2], riakboost::system::error_code& ec);

BOOST_ASIO_DECL bool sockatmark(socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL size_t available(socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL int listen(socket_type s,
    int backlog, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL int send(socket_type s, const buf* bufs,
    size_t count, int flags, riakboost::system::error_code& ec);

BOOST_ASIO_DECL size_t sync_send(socket_type s, state_type state,
    const buf* bufs, size_t count, int flags,
    bool all_empty, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL int setsockopt(socket_type s, state_type& state,
    ...
    std::size_t optlen, riakboost::system::error_code& ec);

BOOST_ASIO_DECL int getsockopt(socket_type s, state_type state,
    int level, int optname, void* optval,
    size_t* optlen, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL int ioctl(socket_type s, state_type& state,
    int cmd, ioctl_arg_type* arg, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL int poll_read(socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL int poll_write(socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL int poll_connect(socket_type s, riakboost::system::error_code& ec);

BOOST_ASIO_DECL const char* inet_ntop(int af, const void* src, char* dest,
    size_t length, unsigned long scope_id, riakboost::system::error_code& ec);
...
BOOST_ASIO_DECL int gethostname(char* name,
    int namelen, riakboost::system::error_code& ec);

BOOST_ASIO_DECL riakboost::system::error_code getaddrinfo(const char* host,
    const char* service, const addrinfo_type& hints,
    addrinfo_type** result, riakboost::system::error_code& ec);

BOOST_ASIO_DECL riakboost::system::error_code background_getaddrinfo(
...
BOOST_ASIO_DECL riakboost::system::error_code getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int flags, riakboost::system::error_code& ec);

BOOST_ASIO_DECL riakboost::system::error_code sync_getnameinfo(
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, riakboost::system::error_code& ec);

BOOST_ASIO_DECL riakboost::system::error_code background_getnameinfo(
    const weak_cancel_token_type& cancel_token,
    const socket_addr_type* addr, std::size_t addrlen,
    char* host, std::size_t hostlen, char* serv,
    std::size_t servlen, int sock_type, riakboost::system::error_code& ec);
