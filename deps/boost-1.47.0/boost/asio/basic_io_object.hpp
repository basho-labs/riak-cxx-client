...
protected:
   ...
   */
  explicit basic_io_object(riakboost::asio::io_service& io_service)
    : service(riakboost::asio::use_service<IoObjectService>(io_service))
  {
...
protected:
  explicit basic_io_object(riakboost::asio::io_service& io_service)
    : service_(&riakboost::asio::use_service<IoObjectService>(io_service))
  {
