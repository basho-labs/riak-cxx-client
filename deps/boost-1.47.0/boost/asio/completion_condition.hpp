 ...
 * @code
 * riakboost::array<char, 128> buf;
 * riakboost::system::error_code ec;
 * std::size_t n = riakboost::asio::read(
 *     sock, riakboost::asio::buffer(buf),
 *     riakboost::asio::transfer_all(), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = riakboost::asio::read(
 *     sock, riakboost::asio::buffer(buf),
 *     riakboost::asio::transfer_at_least(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
 ...
 * std::size_t n = riakboost::asio::read(
 *     sock, riakboost::asio::buffer(buf),
 *     riakboost::asio::transfer_exactly(64), ec);
 * if (ec)
 * {
 *   // An error occurred.
 * }
