...
private:
  ...
  typedef riakboost::asio::detail::resolver_service<InternetProtocol>
    service_impl_type;
...
public:
  ...
  explicit resolver_service(riakboost::asio::io_service& io_service)
...
private:
  ...
  void fork_service(riakboost::asio::io_service::fork_event event)
  {
