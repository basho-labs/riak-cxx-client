...
/**
 * The riakboost::asio::ip::address class provides the ability to use either IP
...
public:
  ...
  BOOST_ASIO_DECL address(const riakboost::asio::ip::address_v4& ipv4_address);

  /// Construct an address from an IPv6 address.
  BOOST_ASIO_DECL address(const riakboost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL address& operator=(
      const riakboost::asio::ip::address_v4& ipv4_address);

  /// Assign from an IPv6 address.
  BOOST_ASIO_DECL address& operator=(
      const riakboost::asio::ip::address_v6& ipv6_address);
  ...
  BOOST_ASIO_DECL riakboost::asio::ip::address_v4 to_v4() const;

  /// Get the address as an IP version 6 address.
  BOOST_ASIO_DECL riakboost::asio::ip::address_v6 to_v6() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string() const;

  /// Get the address as a string in dotted decimal format.
  BOOST_ASIO_DECL std::string to_string(riakboost::system::error_code& ec) const;
  ...
  BOOST_ASIO_DECL static address from_string(
      const char* str, riakboost::system::error_code& ec);
  ...
  /// or from an IPv6 address in hexadecimal notation.
  BOOST_ASIO_DECL static address from_string(
      const std::string& str, riakboost::system::error_code& ec);
...
private:
  ...
  riakboost::asio::ip::address_v4 ipv4_address_;

  // The underlying IPv6 address.
  riakboost::asio::ip::address_v6 ipv6_address_;
};
 ...
 *
 * @relates riakboost::asio::ip::address
 */
