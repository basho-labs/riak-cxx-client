...
/**
 * The riakboost::asio::ip::basic_resolver_query class template describes a query
...
public:
  ...
  const riakboost::asio::detail::addrinfo_type& hints() const
  {
    return hints_;
  }
...
private:
  riakboost::asio::detail::addrinfo_type hints_;
