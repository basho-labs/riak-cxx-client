...
/**
 * The riakboost::asio::ip::address_v6 class provides the ability to use and
...
#else
  typedef riakboost::asio::detail::array<unsigned char, 16> bytes_type;
#endif
...
private:
  ...
  riakboost::asio::detail::in6_addr_type addr_;
 ...
 *
 * @relates riakboost::asio::ip::address_v6
 */
