...
public:
   ...
   */
  explicit basic_resolver(riakboost::asio::io_service& io_service)
   ...
   * will be invoked with the riakboost::asio::error::operation_aborted error code.
   */
  void cancel()
  {
  ...
  iterator resolve(const query& q)
  {
    ...
    riakboost::asio::detail::throw_error(ec, "resolve");
    return i;
  }
   ...
   * entry.
   */
  iterator resolve(const query& q, riakboost::system::error_code& ec)
  {
   ...
   * entry.
   */
  iterator resolve(const endpoint_type& e, riakboost::system::error_code& ec)
  {
