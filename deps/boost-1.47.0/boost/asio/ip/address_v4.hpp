...
/**
 * The riakboost::asio::ip::address_v4 class provides the ability to use and
...
#else
  typedef riakboost::asio::detail::array<unsigned char, 4> bytes_type;
#endif
...
private:
  ...
  riakboost::asio::detail::in4_addr_type addr_;
};
 ...
 *
 * @relates riakboost::asio::ip::address_v4
 */
