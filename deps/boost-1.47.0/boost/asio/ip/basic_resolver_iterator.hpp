...
/**
 * The riakboost::asio::ip::basic_resolver_iterator class template is used to define
...
public:
  ...
  static basic_resolver_iterator create(
      riakboost::asio::detail::addrinfo_type* address_info,
...
private:
  ...
  riakboost::asio::detail::shared_ptr<values_type> values_;
  std::size_t index_;
};
