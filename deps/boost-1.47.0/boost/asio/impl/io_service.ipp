...
io_service::io_service()
  : service_registry_(new riakboost::asio::detail::service_registry(*this)),
...
std::size_t io_service::run(riakboost::system::error_code& ec)
{
  return impl_.run(ec);
}
...
std::size_t io_service::run_one(riakboost::system::error_code& ec)
{
...
std::size_t io_service::poll(riakboost::system::error_code& ec)
{
...
std::size_t io_service::poll_one(riakboost::system::error_code& ec)
{
...
void io_service::notify_fork(riakboost::asio::io_service::fork_event event)
{
  service_registry_->notify_fork(event);
}

io_service::service::service(riakboost::asio::io_service& owner)
  : owner_(owner),
    next_(0)
{
}
...
void io_service::service::fork_service(riakboost::asio::io_service::fork_event)
{
}
