...
inline io_service::work::work(riakboost::asio::io_service& io_service)
...
inline riakboost::asio::io_service& io_service::work::get_io_service()
{
  return io_service_;
}

inline riakboost::asio::io_service& io_service::service::get_io_service()
{
  return owner_;
}
