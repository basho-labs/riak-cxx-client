...
inline std::size_t write(SyncWriteStream& s, const ConstBufferSequence& buffers)
{
  ...
  riakboost::asio::detail::throw_error(ec, "write");
...
namespace detail
{
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, riakboost::asio::mutable_buffers_1,
  ...
  template <typename AsyncWriteStream,
      typename CompletionCondition, typename WriteHandler>
  class write_op<AsyncWriteStream, riakboost::asio::const_buffers_1,
      CompletionCondition, WriteHandler>
    : detail::base_from_completion_cond<CompletionCondition>
  {
  public:
    write_op(AsyncWriteStream& stream,
        const riakboost::asio::const_buffers_1& buffers,
        CompletionCondition completion_condition,
        WriteHandler& handler)
      : detail::base_from_completion_cond<
          CompletionCondition>(completion_condition),
  ...
  //private:
    AsyncWriteStream& stream_;
    riakboost::asio::const_buffer buffer_;
    std::size_t total_transferred_;
    WriteHandler handler_;
  };
...
namespace detail
{
  ...
  {
  public:
    write_streambuf_handler(riakboost::asio::basic_streambuf<Allocator>& streambuf,
        WriteHandler& handler)
  ...
  make_write_streambuf_handler(
      riakboost::asio::basic_streambuf<Allocator>& b, WriteHandler handler)
  {
