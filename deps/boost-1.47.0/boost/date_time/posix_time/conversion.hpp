...
namespace posix_time {
  ...
  inline
  std::tm to_tm(const riakboost::posix_time::ptime& t) {
    std::tm timetm = riakboost::gregorian::to_tm(t.date());
    riakboost::posix_time::time_duration td = t.time_of_day();
  ...
  inline
  std::tm to_tm(const riakboost::posix_time::time_duration& td) {
    std::tm timetm;
  ...
  ptime ptime_from_tm(const std::tm& timetm) {
    riakboost::gregorian::date d = riakboost::gregorian::date_from_tm(timetm);
   ...
   *       riakboost::date_time::winapi::file_time type.
   */
  template< typename TimeT, typename FileTimeT >
  inline
  TimeT from_ftime(const FileTimeT& ft)
  {
    return riakboost::date_time::time_from_ftime<TimeT>(ft);
  }

#endif // BOOST_HAS_FTIME

} } //namespace riakboost::posix_time
