...
namespace winapi {
    ...
    extern "C" {
        ...
        struct FILETIME
        {
            riakboost::uint32_t dwLowDateTime;
            riakboost::uint32_t dwHighDateTime;
        };
        struct SYSTEMTIME
        {
            riakboost::uint16_t wYear;
            riakboost::uint16_t wMonth;
            riakboost::uint16_t wDayOfWeek;
            riakboost::uint16_t wDay;
            riakboost::uint16_t wHour;
            riakboost::uint16_t wMinute;
            riakboost::uint16_t wSecond;
            riakboost::uint16_t wMilliseconds;
        };
    ...
    inline riakboost::uint64_t file_time_to_microseconds(FileTimeT const& ft)
    {
