...
namespace date_time {
  ...
  */
  ...
  class time_duration : private
      riakboost::less_than_comparable<T
    , riakboost::equality_comparable<T
    > >
   ...
   */
  template<class base_duration, riakboost::int64_t frac_of_second>
  class subsecond_duration : public base_duration
  {
  public:
    typedef typename base_duration::traits_type traits_type;
    explicit subsecond_duration(riakboost::int64_t ss) :
