...
namespace date_time {
  ...
  class date_duration : private
              riakboost::less_than_comparable1< date_duration< duration_rep_traits >
            , riakboost::equality_comparable1< date_duration< duration_rep_traits >
            , riakboost::addable1< date_duration< duration_rep_traits >
            , riakboost::subtractable1< date_duration< duration_rep_traits >
            , riakboost::dividable2< date_duration< duration_rep_traits >, int
            > > > > >
  { 
  public:
  ...
  {
    typedef long int_type;
    typedef riakboost::date_time::int_adapter<long> impl_type;
