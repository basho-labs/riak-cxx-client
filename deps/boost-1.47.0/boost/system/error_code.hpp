    ...
    public:
      ...
      template <class ErrorConditionEnum>
        error_condition(ErrorConditionEnum e,
          typename riakboost::enable_if<is_error_condition_enum<ErrorConditionEnum> >::type* = 0)
      {
      ...
      template<typename ErrorConditionEnum>
        typename riakboost::enable_if<is_error_condition_enum<ErrorConditionEnum>, error_condition>::type &
    ...
    public:
      ...
      template <class ErrorCodeEnum>
        error_code(ErrorCodeEnum e,
          typename riakboost::enable_if<is_error_code_enum<ErrorCodeEnum> >::type* = 0)
      {
      ...
      template<typename ErrorCodeEnum>
        typename riakboost::enable_if<is_error_code_enum<ErrorCodeEnum>, error_code>::type &
...
# endif
    ...
    //  "throws" function in namespace riakboost rather than namespace riakboost::system.
