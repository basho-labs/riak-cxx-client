...
template<>
class integer_traits< ::riakboost::long_long_type>
  : public std::numeric_limits< ::riakboost::long_long_type>,
    public detail::integer_traits_base< ::riakboost::long_long_type, LLONG_MIN, LLONG_MAX>
{ };

template<>
class integer_traits< ::riakboost::ulong_long_type>
  : public std::numeric_limits< ::riakboost::ulong_long_type>,
    public detail::integer_traits_base< ::riakboost::ulong_long_type, 0, ULLONG_MAX>
{ };

#elif defined(ULONG_LONG_MAX) && defined(BOOST_HAS_LONG_LONG)

template<>
class integer_traits< ::riakboost::long_long_type>  : public std::numeric_limits< ::riakboost::long_long_type>,    public detail::integer_traits_base< ::riakboost::long_long_type, LONG_LONG_MIN, LONG_LONG_MAX>{ };
template<>
class integer_traits< ::riakboost::ulong_long_type>
  : public std::numeric_limits< ::riakboost::ulong_long_type>,
    public detail::integer_traits_base< ::riakboost::ulong_long_type, 0, ULONG_LONG_MAX>
{ };
...
class integer_traits< ::riakboost::long_long_type>
  : public std::numeric_limits< ::riakboost::long_long_type>,
    public detail::integer_traits_base< ::riakboost::long_long_type, LONGLONG_MIN, LONGLONG_MAX>
{ };

template<>
class integer_traits< ::riakboost::ulong_long_type>
  : public std::numeric_limits< ::riakboost::ulong_long_type>,
    public detail::integer_traits_base< ::riakboost::ulong_long_type, 0, ULONGLONG_MAX>
{ };
...
class integer_traits< ::riakboost::long_long_type>
  : public std::numeric_limits< ::riakboost::long_long_type>,
    public detail::integer_traits_base< ::riakboost::long_long_type, -_LLONG_MAX - _C2, _LLONG_MAX>
{ };

template<>
class integer_traits< ::riakboost::ulong_long_type>
  : public std::numeric_limits< ::riakboost::ulong_long_type>,
    public detail::integer_traits_base< ::riakboost::ulong_long_type, 0, _ULLONG_MAX>
{ };
...
class integer_traits< ::riakboost::long_long_type>
  : public std::numeric_limits< ::riakboost::long_long_type>,
    public detail::integer_traits_base< ::riakboost::long_long_type, (1LL << (sizeof(::riakboost::long_long_type) * CHAR_BIT - 1)), ~(1LL << (sizeof(::riakboost::long_long_type) * CHAR_BIT - 1))>
{ };

template<>
class integer_traits< ::riakboost::ulong_long_type>
  : public std::numeric_limits< ::riakboost::ulong_long_type>,
    public detail::integer_traits_base< ::riakboost::ulong_long_type, 0, ~0uLL>
{ };
