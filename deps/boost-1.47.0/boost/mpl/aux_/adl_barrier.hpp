...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{ namespace mpl { using namespace BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE; 
...
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE riakboost::mpl
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_OPEN namespace riakboost{} namespace boost = riakboost; namespace riakboost{ namespace mpl {
#   define BOOST_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE }}
#   define BOOST_MPL_AUX_ADL_BARRIER_DECL(type) /**/
