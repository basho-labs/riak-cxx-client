...
template< BOOST_MPL_PP_PARAMS(i,typename T) > \
::riakboost::mpl::aux::yes_tag operator|( \
      ::riakboost::mpl::aux::has_rebind_tag<int> \
    , name<BOOST_MPL_PP_PARAMS(i,T)>* \
    ); \
::riakboost::mpl::aux::no_tag operator|( \
      ::riakboost::mpl::aux::has_rebind_tag<int> \
    , name< BOOST_MPL_PP_ENUM(i,::riakboost::mpl::na) >* \
    ); \
/**/
...
::riakboost::mpl::aux::yes_tag operator|( \
      ::riakboost::mpl::aux::has_rebind_tag<int> \
    , ::riakboost::mpl::aux::has_rebind_tag< name<BOOST_MPL_PP_PARAMS(i,T)> >* \
    ); \
/**/
#else
#   define BOOST_MPL_AUX_LAMBDA_SUPPORT_HAS_REBIND(i, name, params) /**/
