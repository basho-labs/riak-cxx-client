...
riakboost::mpl::aux::weighted_tag<1>::type operator==( assert_, assert_ );
riakboost::mpl::aux::weighted_tag<2>::type operator!=( assert_, assert_ );
riakboost::mpl::aux::weighted_tag<3>::type operator>(  assert_, assert_ );
riakboost::mpl::aux::weighted_tag<4>::type operator>=( assert_, assert_ );
riakboost::mpl::aux::weighted_tag<5>::type operator<( assert_, assert_ );
riakboost::mpl::aux::weighted_tag<6>::type operator<=( assert_, assert_ );
...
template< typename Pred >
failed ************ (riakboost::mpl::not_<Pred>::************ 
...
template< typename Pred >
typename assert_arg_type< riakboost::mpl::not_<Pred> >::type 
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          riakboost::mpl::assertion_failed<false>( \
              riakboost::mpl::assert_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
    ) \
/**/
...
enum { \
      BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
          riakboost::mpl::assertion<false>::failed( \
              riakboost::mpl::assert_not_arg( (void (*) pred)0, 1 ) \
            ) \
        ) \
}\
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        riakboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
            (riakboost::mpl::failed ************ ( riakboost::mpl::assert_relation< \
                  riakboost::mpl::assert_::relations( sizeof( \
                      riakboost::mpl::assert_::arg rel riakboost::mpl::assert_::arg \
                    ) ) \
                , x \
                , y \
                >::************)) 0 ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
    ...
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        riakboost::mpl::assertion_failed<BOOST_PP_CAT(mpl_assert_rel_value,counter)>( \
              riakboost::mpl::assert_rel_arg( riakboost::mpl::assert_relation< \
                  riakboost::mpl::assert_::relations(BOOST_PP_CAT(mpl_assert_rel,counter)) \
                , x \
                , y \
                >() ) \
            ) \
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        riakboost::mpl::assertion_failed<(x rel y)>( riakboost::mpl::assert_rel_arg( \
              riakboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&riakboost::mpl::operator rel))() \
            ) ) \
        ) \
    ) \
/**/
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,BOOST_MPL_AUX_PP_COUNTER()) = sizeof( \
        riakboost::mpl::assertion_failed<(x rel y)>( (riakboost::mpl::failed ************ ( \
            riakboost::mpl::BOOST_MPL_AUX_ASSERT_RELATION(x,y,(&riakboost::mpl::operator rel))::************))0 ) \
        ) \
    ) \
/**/
#   endif
...
struct msg; \
typedef struct BOOST_PP_CAT(msg,counter) : riakboost::mpl::assert_ \
{ \
    using riakboost::mpl::assert_::types; \
    static riakboost::mpl::failed ************ (msg::************ assert_arg()) types_ \
    { return 0; } \
} BOOST_PP_CAT(mpl_assert_arg,counter); \
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        riakboost::mpl::assertion<(c)>::failed( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#else
...
BOOST_MPL_AUX_ASSERT_CONSTANT( \
      std::size_t \
    , BOOST_PP_CAT(mpl_assertion_in_line_,counter) = sizeof( \
        riakboost::mpl::assertion_failed<(c)>( BOOST_PP_CAT(mpl_assert_arg,counter)::assert_arg() ) \
        ) \
    ) \
/**/
#endif
