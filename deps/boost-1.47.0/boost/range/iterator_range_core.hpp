...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    namespace iterator_range_detail
    {
        ...
        struct iterator_range_impl {
            ...
            {
                return static_cast<IteratorT>( riakboost::begin( r ) );
            }

            template< class ForwardRange >
            static IteratorT adl_end( ForwardRange& r )
            {
                return static_cast<IteratorT>( riakboost::end( r ) );
            }
        };
        ...
        {
            return std::lexicographical_compare( riakboost::begin(l),
                                                 riakboost::end(l),
                                                 riakboost::begin(r),
                                                 riakboost::end(r) );
        }
...
//  iterator range template class -----------------------------------------//
        ...
        /*!
            ...
            \code
                riakboost::tolower( find( s, "UPPERCASE STRING" ) );
            \endcode
        ...
        */
        ...
        private: // for return value of operator()()
            typedef BOOST_DEDUCED_TYPENAME
                riakboost::mpl::if_< riakboost::is_abstract<value_type>,
...
//  iterator range utilities -----------------------------------------//
        ...
        */
        ...
        make_iterator_range( Range& r )
        {
            return iterator_range< BOOST_DEDUCED_TYPENAME range_iterator<Range>::type >
                ( riakboost::begin( r ), riakboost::end( r ) );
        }
        ...
        namespace iterator_range_detail
        {
                             ...
                             BOOST_DEDUCED_TYPENAME range_difference<Range>::type advance_end )
            {
                ...
                BOOST_DEDUCED_TYPENAME range_iterator<Range>::type
                    new_begin = riakboost::begin( r ),
                    new_end   = riakboost::end( r );
        ...
        */
        ...
        {
            return SeqT( riakboost::begin( r ), riakboost::end( r ) );
        }
