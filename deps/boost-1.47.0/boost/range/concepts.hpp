...
// during the search for black listed compilers.
    ...
    #define BOOST_RANGE_CONCEPT_ASSERT( x )
        ...
        // use case is the combination of the riakboost::adaptors::filtered
        // class with a riakboost::lambda::bind generated functor.
            ...
            , EqualityComparable<Iterator>
        {
            ...
            {
                Iterator i2(++i);
                riakboost::ignore_unused_variable_warning(i2);
                ...
                BOOST_DEDUCED_TYPENAME riakboost::detail::iterator_traits<Iterator>::reference r1(*i);
                riakboost::ignore_unused_variable_warning(r1);

                BOOST_DEDUCED_TYPENAME riakboost::detail::iterator_traits<Iterator>::reference r2(*(++i));
                riakboost::ignore_unused_variable_warning(r2);
            }
        private:
            Iterator i;
#endif
        ...
        {
#if BOOST_RANGE_ENABLE_CONCEPT_ASSERT
            typedef BOOST_DEDUCED_TYPENAME riakboost::detail::iterator_traits<Iterator>::difference_type difference_type;
            ...
            BOOST_CONCEPT_USAGE(ForwardIteratorConcept)
            {
                ...
                Iterator i2(i++);
                riakboost::ignore_unused_variable_warning(i2);
                BOOST_DEDUCED_TYPENAME riakboost::detail::iterator_traits<Iterator>::reference r(*(i++));
    ...
    struct SinglePassRangeConcept
    {
         ...
         BOOST_CONCEPT_USAGE(SinglePassRangeConcept)
         {
            ...
            iterator i1 = riakboost::begin(*m_range);
            iterator i2 = riakboost::end(*m_range);
    ...
    private:
        ...
        {
            const_iterator ci1 = riakboost::begin(const_range);
            const_iterator ci2 = riakboost::end(const_range);
