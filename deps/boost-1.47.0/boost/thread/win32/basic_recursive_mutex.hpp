...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    namespace detail
    {
        ...
        struct basic_recursive_mutex_impl
        {
            ...
            bool timed_lock(::riakboost::system_time const& target)
            {
                long const current_thread_id=win32::GetCurrentThreadId();
        ...
        private:
            ...
            {
                if(::riakboost::detail::interlocked_read_acquire(&locking_thread_id)==current_thread_id)
                {
                    ++recursion_count;
                    return true;
                }
            ...
            bool try_timed_lock(long current_thread_id,::riakboost::system_time const& target)
            {
