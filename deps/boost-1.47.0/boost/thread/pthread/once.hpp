...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    ...
    struct once_flag
    {
        riakboost::uintmax_t epoch;
    };

    namespace detail
    {
        BOOST_THREAD_DECL riakboost::uintmax_t& get_once_per_thread_epoch();
        BOOST_THREAD_DECL extern riakboost::uintmax_t once_global_epoch;
