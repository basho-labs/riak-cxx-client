...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{
    ...
    exception_ptr
        {
        typedef riakboost::shared_ptr<exception_detail::clone_base const> impl;
        impl ptr_;
...
# endif
    ...
    exception_detail
        ...
        get_boost_exception( T const * x )
            {
            return dynamic_cast<riakboost::exception const *>(x);
            }
#endif
        ...
        current_exception_std_exception( T const & e1 )
            {
            if( riakboost::exception const * e2 = get_boost_exception(&e1) )
                return riakboost::copy_exception(current_exception_std_exception_wrapper<T>(e1,*e2));
            else
                return riakboost::copy_exception(current_exception_std_exception_wrapper<T>(e1));
            }
