...
BOOST_STATIC_CONSTANT(
      std::size_t
    , alignment_of_max_align = ::riakboost::alignment_of<max_align>::value
    );
...
public: // constants
    ...
    BOOST_STATIC_CONSTANT(
        ...
        , alignment = (
              alignment_ == std::size_t(-1)
            ? ::riakboost::detail::aligned_storage::alignment_of_max_align
            : alignment_
            )
        );
...
struct is_pod<riakboost::detail::aligned_storage::aligned_storage_imp<size_,alignment_> >
