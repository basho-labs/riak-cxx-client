...
#  define BOOST_LIB_NAME riakboost_unit_test_framework
...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{ namespace unit_test {
...
{
    return ::riakboost::unit_test::unit_test_main( &init_unit_test, argc, argv );
}
