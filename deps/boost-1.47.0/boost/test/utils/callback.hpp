...
private:
    // Data members
    riakboost::shared_ptr<ut_detail::callback0_impl<R> > m_impl;
};
...
private:
    // Data members
    riakboost::shared_ptr<ut_detail::callback1_impl<R,T1> > m_impl;
};
...
private:
    // Data members
    riakboost::shared_ptr<ut_detail::callback2_impl<R,T1,T2> > m_impl;
};
...
private:
    // Data members
    riakboost::shared_ptr<ut_detail::callback3_impl<R,T1,T2,T3> > m_impl;
};
