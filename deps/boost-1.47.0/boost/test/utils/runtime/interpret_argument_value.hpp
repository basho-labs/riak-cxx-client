...
struct interpret_argument_value_impl {
    static bool _( cstring source, riakboost::optional<T>& res )
    {
...
struct interpret_argument_value_impl<dstring> {
    static bool _( cstring source, riakboost::optional<dstring>& res )
    {
...
struct interpret_argument_value_impl<cstring> {
    static bool _( cstring source, riakboost::optional<cstring>& res )
    {
...
struct interpret_argument_value_impl<bool> {
    static bool _( cstring source, riakboost::optional<bool>& res )
    {
...
template<typename T>
inline bool
interpret_argument_value( cstring source, riakboost::optional<T>& res, long )
{
...
template<typename T>
inline bool
interpret_argument_value( cstring source, riakboost::optional<std::list<T> >& res, int )
{
