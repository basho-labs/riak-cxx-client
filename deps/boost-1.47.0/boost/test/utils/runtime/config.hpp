...
#include <boost/test/utils/basic_cstring/io.hpp> // operator<<(riakboost::runtime::cstring)
...
#define BOOST_RT_PARAM_PUTENV ::riakboost::BOOST_RT_PARAM_NAMESPACE::putenv_impl
