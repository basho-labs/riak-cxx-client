                 ...
                 cstring                name_part5 )
{
    if( name_part2.is_empty() ) {
        riakboost::optional<cstring> res;
...
get_requ_param_value( param_namespace const& where_from,
                      ...
                      cstring                name_part5 )
{
    riakboost::optional<cstring> v = get_param_value( where_from, name_part1, name_part2, name_part3, name_part4, name_part5 );
