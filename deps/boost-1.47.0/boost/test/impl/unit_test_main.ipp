...
public:
    ...
    void            filter_unit( test_unit const& tu )
    {
        ...
        tu.p_enabled.value =
            std::find_if( filters.begin(), filters.end(), bind( &single_filter::pass, _1, riakboost::ref(tu) ) ) != filters.end();
    }
...
main( int argc, char* argv[] )
{
    ...
    riakboost::unit_test::init_unit_test_func init_func = &init_unit_test;
#else
    extern ::riakboost::unit_test::test_suite* init_unit_test_suite( int argc, char* argv[] );

    riakboost::unit_test::init_unit_test_func init_func = &init_unit_test_suite;
#endif

    return ::riakboost::unit_test::unit_test_main( init_func, argc, argv );
}
