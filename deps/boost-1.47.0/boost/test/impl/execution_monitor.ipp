...
extract( riakboost::exception const* ex )
{
    if( !ex )
        return 0;

    typename ErrorInfo::value_type const * val = riakboost::get_error_info<ErrorInfo>( *ex );
...
static void
report_error( execution_exception::error_code ec, riakboost::exception const* be, char const* format, va_list* args )
{
...
static void
report_error( execution_exception::error_code ec, riakboost::exception const* be, char const* format, ... )
{
    va_list args;
    va_start( args, format );
...
// ************************************************************************** //
// **************    riakboost::detail::system_signal_exception    ************** //
// ************************************************************************** //
...
// ************************************************************************** //
// **************         riakboost::detail::signal_action         ************** //
// ************************************************************************** //
...
// ************************************************************************** //
// **************        riakboost::detail::signal_handler         ************** //
// ************************************************************************** //
...
execution_monitor::execute( unit_test::callback0<int> const& F )
{
    ...
    //  std:: exceptions
      ...
      { detail::report_error( execution_exception::cpp_exception_error, 
                              current_exception_cast<riakboost::exception const>(),
    ...
    catch( riakboost::exception const& ex )
    { detail::report_error( execution_exception::cpp_exception_error, 
                            &ex,
                            "unknown riakboost::exception" ); }
