...
#define BOOST_TEST_LOG_ENTRY( ll )                                                  \
    (::riakboost::unit_test::unit_test_log                                              \
        << ::riakboost::unit_test::log::begin( BOOST_TEST_L(__FILE__), __LINE__ ))(ll)  \
/**/
...
#define BOOST_TEST_MESSAGE( M )                                 \
    BOOST_TEST_LOG_ENTRY( ::riakboost::unit_test::log_messages )    \
    << (::riakboost::unit_test::lazy_ostream::instance() << M)      \
/**/

//____________________________________________________________________________//

#define BOOST_TEST_PASSPOINT()                                  \
    ::riakboost::unit_test::unit_test_log.set_checkpoint(           \
...
#define BOOST_TEST_CHECKPOINT( M )                              \
    ::riakboost::unit_test::unit_test_log.set_checkpoint(           \
        BOOST_TEST_L(__FILE__),                                 \
        static_cast<std::size_t>(__LINE__),                     \
        (::riakboost::wrap_stringstream().ref() << M).str() )       \
/**/
