...
riakboost::unit_test::make_test_case( riakboost::unit_test::callback0<>(test_function), BOOST_TEST_STRINGIZE( test_function ) )
#define BOOST_CLASS_TEST_CASE( test_function, tc_instance ) \
riakboost::unit_test::make_test_case((test_function), BOOST_TEST_STRINGIZE( test_function ), tc_instance )
...
( new riakboost::unit_test::test_suite( testsuite_name ) )
...
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    riakboost::unit_test::make_test_case(                                   \
        &BOOST_AUTO_TC_INVOKER( test_name ), #test_name ),              \
    riakboost::unit_test::ut_detail::auto_tc_exp_fail<                      \
...
struct BOOST_AUTO_TC_INVOKER( test_name ) {                             \
    ...
    static void run( riakboost::type<TestType>* = 0 )                       \
    {                                                                   \
        ...
        t.test_method();                                                \
                                                                        ...
                                                                        \
BOOST_AUTO_TU_REGISTRAR( test_name )(                                   \
    riakboost::unit_test::ut_detail::template_test_case_gen<                \
...
#define BOOST_TEST_CASE_TEMPLATE( name, typelist )                          \
    riakboost::unit_test::ut_detail::template_test_case_gen<name,typelist >(    \
...
template<typename type_name>                                    \
void BOOST_JOIN( name, _impl )( riakboost::type<type_name>* );      \
                                                                \
struct name {                                                   \
    template<typename TestType>                                 \
    static void run( riakboost::type<TestType>* frwrd = 0 )         \
    {                                                           \
...
static riakboost::unit_test::ut_detail::global_fixture_impl<F> BOOST_JOIN( gf_, F ) ; \
/**/
...
namespace riakboost{} namespace boost = riakboost; namespace riakboost{ namespace unit_test { namespace ut_detail {
...
typedef ::riakboost::unit_test::ut_detail::nil_t BOOST_AUTO_TEST_CASE_FIXTURE;
...
static riakboost::unit_test::ut_detail::auto_test_unit_registrar BOOST_JOIN( BOOST_JOIN( test_name, _registrar ), __LINE__ )
...
bool init_unit_test()                   {
#else
::riakboost::unit_test::test_suite*
init_unit_test_suite( int, char* [] )   {
#endif

#ifdef BOOST_TEST_MODULE
    using namespace ::riakboost::unit_test;
