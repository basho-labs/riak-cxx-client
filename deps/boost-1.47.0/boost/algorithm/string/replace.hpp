...
//  replace_range --------------------------------------------------------------------//
        ...
        */
            ...
            const Range2T& Format)
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::range_finder(SearchRange),
        ...
        */
        ...
        inline void replace_range( 
            ...
            const RangeT& Format)
        {
            ::riakboost::algorithm::find_format(
                Input,
                ::riakboost::algorithm::range_finder(SearchRange),
                ::riakboost::algorithm::const_formatter(Format));
        }
        ...
        */
            ...
            const Range3T& Format)
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::first_finder(Search),
                ::riakboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::last_finder(Search),
                ::riakboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range3T& Format )
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::nth_finder(Search, Nth),
                ::riakboost::algorithm::const_formatter(Format) );
        }
       ...
       */
            ...
            const std::locale& Loc=std::locale() )
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::nth_finder(Search, Nth, is_iequal(Loc) ),
                ::riakboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::head_finder(N),
                ::riakboost::algorithm::const_formatter(Format) );
        }
        ...
        */
            ...
            const Range2T& Format )
        {
            return ::riakboost::algorithm::find_format_copy(
                Output,
                Input,
                ::riakboost::algorithm::tail_finder(N),
                ::riakboost::algorithm::const_formatter(Format) );
        }
