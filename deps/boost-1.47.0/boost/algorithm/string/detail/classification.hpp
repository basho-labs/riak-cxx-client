   ...
   // is_classified functor
            ...
            */
            ...
            private:
                ...
                typedef typename ::riakboost::remove_const<CharT>::type set_value_type;
            ...
            public:     
                ...
                is_any_ofF( const RangeT& Range ) : m_Size(0)
                {
                    ...
                    std::size_t Size=::riakboost::distance(Range);
                    m_Size=Size;
                    ...
                    // Use fixed storage
                    ::std::copy(::riakboost::begin(Range), ::riakboost::end(Range), Storage);
