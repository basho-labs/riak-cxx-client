...
//  insert helpers  -------------------------------------------------//
            ...
            {
                ::riakboost::algorithm::detail::insert( Input, At, ::riakboost::begin(Insert), ::riakboost::end(Insert) );
            }
...
//  replace helper  -------------------------------------------------//
                ...
                const InsertT& Insert )
            {
                if(From!=To)
                {
                    ::riakboost::algorithm::detail::replace( Input, From, To, ::riakboost::begin(Insert), ::riakboost::end(Insert) );
                }
                else
                {
                    ::riakboost::algorithm::detail::insert( Input, From, ::riakboost::begin(Insert), ::riakboost::end(Insert) );
                }
            }
