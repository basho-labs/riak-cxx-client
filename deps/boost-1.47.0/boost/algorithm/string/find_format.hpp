...
// generic replace  -----------------------------------------------------------------//
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            iterator_range<BOOST_STRING_TYPENAME range_const_iterator<RangeT>::type> lit_input(::riakboost::as_literal(Input));

            return detail::find_format_copy_impl(
                Output,
                lit_input,
                Formatter,
                Finder( ::riakboost::begin(lit_input), ::riakboost::end(lit_input) ) );
        }
        ...
        */
            ...
            FormatterT Formatter )
        {
            ...
            return detail::find_format_copy_impl(
                Input,
                Formatter,
                Finder(::riakboost::begin(Input), ::riakboost::end(Input)));
        }
