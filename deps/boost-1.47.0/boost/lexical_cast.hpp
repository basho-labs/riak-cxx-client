...
#define BOOST_LCAST_DEF(T)          \
        ...
        BOOST_LCAST_DEF(riakboost::ulong_long_type)
        BOOST_LCAST_DEF(riakboost::long_long_type )
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator<<(riakboost::ulong_long_type);
            bool operator<<(riakboost::long_long_type );
#elif defined(BOOST_HAS_MS_INT64)
...
#if defined(BOOST_HAS_LONG_LONG)
            bool operator>>( riakboost::ulong_long_type& output)
            {
                return input_operator_helper_unsigned(output);
            }

            bool operator>>(riakboost::long_long_type& output)
            {
                return input_operator_helper_signed(output);
            }
    ...
    namespace detail // lcast_streambuf_for_target
    {
        ...
        struct lcast_streambuf_for_target
        {
            BOOST_STATIC_CONSTANT(bool, value =
                (
                 ::riakboost::type_traits::ice_not< is_integral<Target>::value >::value
                )
            );
        };
...
# pragma warning( disable : 4267 ) // conversion from 'size_t' to 'unsigned int'
        ...
        template< typename Target
                ...
                >
        Target lexical_cast(
            BOOST_DEDUCED_TYPENAME riakboost::call_traits<Source>::param_type arg,
            CharT* buf, std::size_t src_len)
        {
            typedef BOOST_DEDUCED_TYPENAME
                deduce_char_traits<CharT,Target,Source>::type traits;

            typedef BOOST_DEDUCED_TYPENAME riakboost::mpl::if_c<
            ...
            BOOST_DEDUCED_TYPENAME riakboost::mpl::if_c<
                Unlimited
...
# pragma warning( pop )
            ...
            BOOST_STATIC_CONSTANT(bool, value =
                (
                    ::riakboost::type_traits::ice_or<
                        ...
                        >::value,
                        ::riakboost::type_traits::ice_and<
                             ::riakboost::type_traits::ice_eq< sizeof(char),sizeof(Target)>::value,
                             ::riakboost::type_traits::ice_eq< sizeof(char),sizeof(Source)>::value,
                             is_char_or_wchar<Target>::value,
        ...
        class precision_loss_error : public riakboost::numeric::bad_numeric_cast
        {
         public:
            virtual const char * what() const throw()
        ...
        {
         typedef riakboost::numeric::Trunc<S> Rounder;
        ...
        struct lexical_cast_dynamic_num_not_ignoring_minus
        {
            ...
            {
                try{
                    typedef riakboost::numeric::converter<
                            Target,
                            Source,
                            riakboost::numeric::conversion_traits<Target,Source>,
                            riakboost::numeric::def_overflow_handler,
                            throw_on_precision_loss<Source>
                    > Converter ;

                    return Converter::convert(arg);
                } catch( ::riakboost::numeric::bad_numeric_cast const& ) {
                    BOOST_LCAST_THROW_BAD_CAST(Source, Target);
                }
            }
        };
         ...
         *
         *
         * Rule 2) required because riakboost::lexical_cast has the behavior of
        ...
        struct lexical_cast_dynamic_num
        {
            static inline Target lexical_cast_impl(const Source &arg)
            {
                typedef BOOST_DEDUCED_TYPENAME ::riakboost::mpl::if_c<
                    ::riakboost::type_traits::ice_and<
                        ::riakboost::type_traits::ice_or<
                            ::riakboost::is_signed<Source>::value,
                            ::riakboost::is_float<Source>::value
                        >::value,
                        ::riakboost::type_traits::ice_not<
                        ...
                        >::value,
                        ::riakboost::is_unsigned<Target>::value
                    >::value,
    ...
    inline Target lexical_cast(const Source &arg)
    {
        ...
        typedef BOOST_DEDUCED_TYPENAME ::riakboost::type_traits::ice_or<
